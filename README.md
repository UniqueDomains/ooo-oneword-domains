# Available .OOO One-Word Domains (8,906)
...
**Public extract:** 8,907 rows · **Live catalog:** 8,906 domains
...
| ----------------------- | ------------------------------------------------ |
| 8,907-row public sample | 8,906 live domains                               |
...
> Unique Domains. *Available .OOO One-Word Domains*. Version 2026-04-12. Public GitHub extract for the exact Unique Domains search represented by this repository.
